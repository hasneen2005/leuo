...
app = Client("YouTubeSearch",api_id=28509955,api_hash='4388e8e3adff0695399f439dcae25436',bot_token='1853062674:AAGiH7EtlT81iRx34crooEvrj6Tjo-M8k4M')
...
def FetchLink(link, format='video'):
    return yt_dlp.YoutubeDL(
        {"format": "bestaudio[ext=m4a]" if format == "audio" else "best"}
    ).extract_info(
        url=link,
        download=False
    )["url"]
